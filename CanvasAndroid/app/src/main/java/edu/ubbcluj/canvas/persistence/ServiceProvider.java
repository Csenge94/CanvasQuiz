package edu.ubbcluj.canvas.persistence;
...
public class ServiceProvider {
    ...
    public void initialize(Context context) {
        ...
        for (String key : keySet) {
            ...
            String[] splitterValue = value.split(";");
            service_started = Boolean.valueOf(splitterValue[0]);
            announcementUnreadCount = Integer.parseInt(splitterValue[1]);
            newAnnouncementUnreadCount = Integer.parseInt(splitterValue[2]);
        }
    }
    ...
    private void saveStateToSharedPreferences() {
        ...
        String key = "service";
        String value = (service_started ? "true" : "false") + ";" + announcementUnreadCount + ";" + newAnnouncementUnreadCount;
